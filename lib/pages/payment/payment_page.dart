...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  void initState() {
    super.initState();
    selectedUrl =
        '${AppConstans.baseUrl}/payment-mobile?customer_id=${widget.orderModel.userId}&order_id=${widget.orderModel.id}';
  ...
  void _redirect(String url) {
    ...
    if (_canRedirect) {
      bool _isSuccess =
          url.contains('success') && url.contains(AppConstans.baseUrl);
      bool _isFailed =
          url.contains('fail') && url.contains(AppConstans.baseUrl);
      bool _isCancel =
          url.contains('cancel') && url.contains(AppConstans.baseUrl);
